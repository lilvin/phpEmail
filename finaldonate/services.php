...
<div id="templatemo_main">
    ...
    <div class="col one_third fp_services">
        ...
        <div class="rp_pp">
            ...
            <a href="blog.html">Step one</a>
            <p> Go to the facility of appointment and test questions about your health are asked. It is advisable to give any health related issues you know of about yourself. <a href="blog.html">learn more </a></p>
            <div class="cleaner"></div>
        </div>
        <div class="rp_pp">
            <img src="images/templatemo_image_03.jpg" alt="Image 03" />
            <a href="blog.html">Step two</a>
            <p>If you pass the test you are directed to the donation room and the blood donation process is carried out. A side sample is also taken.<a href="blog.html">learn more </a></p>
            <div class="cleaner"></div>
        </div>
		<div class="rp_pp">
            <img src="images/templatemo_image_03.jpg" alt="Image 03" />
            <a href="blog.html">Step three</a>
            <p>After the process is complete you are given refreshments to regain strength and advised on how to recover. the donated blood is separated to various components and tested. If the status is negative it is transfused.<a href="blog.html">learn more </a></p>
            <div class="cleaner"></div>
        </div>
    </div>
 <div class="col one_third fp_services">
        ...
        <div class="rp_pp">
            <img src="images/templatemo_image_03.jpg" alt="Image 03" />
            <a href="blog.html">Step two</a>
            <p>If you pass the test you are directed to the tranfusion room and side sample is also taken for testing of blood type among other entities. It is also verified if the required blood component is available.<a href="blog.html">learn more </a></p>
            <div class="cleaner"></div>
        </div>
		<div class="rp_pp">
            <img src="images/templatemo_image_03.jpg" alt="Image 03" />
            <a href="blog.html">Step three</a>
            <p>After the process is complete you are given the preparation needed for the transfusion.<a href="blog.html">learn more </a></p>
            <div class="cleaner"></div>
        </div>
    </div>	
