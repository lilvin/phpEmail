...
<table width="707" height="373" border="1" align="center" height:400px; >
  <tr>
    ...
    <table width="332" border="1" align="center">
     ...
     <tr>
        <td colspan="2"> <div align="center">
		  ...
		  <!-- <input name="all" type="submit" id="all" value="list of all recipients appointments" /> -->
		          </div></td>
      </tr>
    </table>
	 </form>
   <form  method="post"  action="allRecepients.php">
     <button
       class="btn btn-success my-2 my-sm-0" type="submit" id="all" name="all">list of all recipients appointments
     </button>
   </form>
