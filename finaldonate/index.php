    ...
    <h2>Welcome!</h2>
        ...
        <p>Donate bLood and help save a life today. Register as a recipient to find a transfusion centre. Register as a donor and save upto three 
  		...
  		<ul class="templatemo_list">
            <li class="flow"><a href="login.html">Login to your account or create a new account.</a></li>
            <li class="flow nomr"><a href="login.html">Book an appointment at your nearest hospital.</a></li>
