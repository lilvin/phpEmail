...
<table width="719" height="373" border="1" align="center" height:400px; >
  <tr>
  ...
  <form id="form1" name="form1" method="post" action="processedbloodcon.php">
    ...
    <table width="332" border="1" align="center">
      ...
      <tr>
        ...
        <td width="207"><p>
          <input name="ID" id="ID" maxlength="8" >
          </input>
        </p>        </td>
      </tr>
	  	        <tr>
...
<tr>
	   <td><span class="style3">Blood Type</span></td>
        ...
        <td><span class="style3">Blood Status</span> </td>
         <td><select name="status" size="1" id="status" value="<?php echo $status; ?>">
	   ...
	   <tr>
        ...
        <td><input name="edate" type="date" id="edate" >
                        </input></td>
      </tr>
      <tr>
        <td colspan="2">&nbsp;</td>
