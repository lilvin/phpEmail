...
if (isset($_POST['all']))
	...
	//blood group A-
	$query ="SELECT * FROM processedblood WHERE (type='A-')";
  ...
  if ($query_run= mysqli_query($con,$query)){
	...
	$query ="SELECT * FROM transfusedblood WHERE (type='A-')";
  ...
  if ($query_run= mysqli_query($con,$query)){
	...
	//BLOOD GROUP B+
	$query ="SELECT * FROM processedblood WHERE (type='B+')";
  ...
  if ($query_run= mysqli_query($con,$query)){
	...
	$query ="SELECT * FROM transfusedblood WHERE (type='B+')";
...
//BLOOD GROUP b-
  ...
  if ($query_run= mysqli_query($con,$query)){
	...
	//BLOOD GROUP Ab+
	$query ="SELECT * FROM processedblood WHERE (type='AB+')";
  ...
  if ($query_run= mysqli_query($con,$query)){
	...
	$query ="SELECT * FROM transfusedblood WHERE (type='AB+')";
  ...
  if ($query_run= mysqli_query($con,$query)){
	...
	//BLOOD GROUP O+
	$query ="SELECT * FROM processedblood WHERE (type='O+')";
  ...
  if ($query_run= mysqli_query($con,$query)){
	...
	$query ="SELECT * FROM transfusedblood WHERE (type='O+')";
...
<div id="templatemo_main">
  ...
  <form id="form1" name="form1" method="post" action="bloodcount.php">
	...
	<tr>
	  ...
	  <tr>
         <td align="center" class="style7" style="color: #000000"><input name="details" type="submit" id="details" value="Get Details" /> </td>
      </tr>
	 </table>
