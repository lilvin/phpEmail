...
<!--newtable inside big table -->
  ...
  <form id="form1" name="form1" method="post" action="discardbloodcon.php">
    <label></label>
    <p>
      <label></label>
    </p>
    <table width="332" border="1" align="center">
      <tr>
        <th colspan="2" class="style3" scope="col">Use date to delete expired blood </th>
      </tr>
	  	        <tr>
        <td width="109"><span class="style3">Expiry Date </span></td>
        <td width="207"><p>
     ...
     <tr>
        <td colspan="2"> <div align="center">
          <input name="delete" type="submit" id="delete" value="Delete Records" /></br></br>
        </div></td>
      </tr>
    </table>
	<p></p>
	<table width="332" border="1" align="center">
      <tr>
        <th colspan="2" class="style3" scope="col">Use status to delete infected blood </th>
      </tr>
	  	        <tr>
        <td width="109" class="style3">Status</td>
        <td width="207"><p>
     ...
     <tr>
        <td colspan="2"> <div align="center">
          <input name="deletes" type="submit" id="deletes" value="Delete Records" />
          </br></br>
        </div></td>
      </tr>
    </table>
